...
public class StartGame extends JFrame {
	...
	private PanelFondo fondo = new PanelFondo(800, 30); //Se crea una relaci�n Has-a, porque el JFrame tiene un PanelFondo.
	...
	public StartGame() {
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent evt) { //Este listener se ejecuta cuando se presiona una tecla.
				if (evt.getKeyCode() == KeyEvent.VK_LEFT) { //Aqu� se consulta si se seleccion� la flecha izquierda del teclado.
		...
		fondo.setBounds(10,10,800,800); //Esta instrucci�n posisiona el panel.
		getContentPane().add(fondo); //Al Jframe se le a�ade el fondo (Aqu� es donde se llama al m�todo pintor de la clase PanelFondo), dicho m�todo dibuja todos los cuadros del fondo.
